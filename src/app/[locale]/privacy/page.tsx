...
export const metadata: Metadata = {
  title: "Privacy Policy | Prerna Packers and Movers",
  description: "Read our privacy policy to understand how we protect your data during the relocation process.",
};
          ...
          <div className="prose prose-zinc max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-zinc-600 leading-relaxed">
                At Prerna Packers and Movers, we respect your privacy and are committed to protecting your personal data. This privacy policy will inform you as to how we look after your personal data when you visit our website (regardless of where you visit it from) or use our relocation services.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2 text-zinc-600">
                ...
                <li><strong>Contact Data:</strong> includes pickup address, delivery address, email address and telephone numbers.</li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 space-y-2 text-zinc-600 mt-4">
                <li>Where we need to perform the contract we are about to enter into or have entered into with you (e.g., executing your relocation).</li>
